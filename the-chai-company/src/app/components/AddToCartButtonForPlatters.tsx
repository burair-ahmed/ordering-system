...
const AddToCartButtonForPlatters: FC<AddToCartButtonForPlattersProps> = ({
  ...
  <button
    ...
    className={`relative overflow-hidden rounded-2xl px-10 py-4 mt-8 transition-all duration-300 ease-in-out font-bold text-white shadow-xl
    ${disabled ? "bg-gray-300 cursor-not-allowed grayscale" : "bg-gradient-to-r from-[#C46A47] to-[#A65638] hover:scale-[1.02] hover:shadow-[#C46A47]/30"} 
    ${className}`}
    disabled={disabled}
  >
