...
async function checkDatabaseImages() {
  try {
    ...
    console.log("\n--- SUMMARY ---");
    console.log(`MenuItems: Total = ${menuItems.length}, Base64 = ${menuBase64Count}, URL = ${menuUrlCount}, Other = ${menuOtherCount}`);
    console.log(`Platters: Total = ${platters.length}, Base64 = ${platterBase64Count}, URL = ${platterUrlCount}, Other = ${platterOtherCount}`);
